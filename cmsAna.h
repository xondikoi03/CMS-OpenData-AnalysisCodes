...
// Mon Jul  8 20:54:44 2024 by ROOT version 6.28/04
// from TTree Events/Events
// found on file: singlemuon_sample.root
//////////////////////////////////////////////////////////
...
public :
  ...
  void decorate(TH1*h, int linecolor, int linewidth, int markercolor, int markerstyle, int tofill);
  void BookHistograms();
...
private:
  ...
  TFile *_HstFile; //The output hist file
